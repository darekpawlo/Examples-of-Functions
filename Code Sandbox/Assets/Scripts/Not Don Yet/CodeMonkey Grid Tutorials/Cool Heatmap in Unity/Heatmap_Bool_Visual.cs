...
public class Heatmap_Bool_Visual : MonoBehaviour
{
    private Generic_Grid<bool> grid;
    private Mesh mesh;
    ...
    public void SetGrid(Generic_Grid<bool> grid)
    {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridVauleChanged(object sender, Generic_Grid<bool>.OnGridValueChangedEventArgs e)
    {
        updateMesh = true;
    }
