...
public class Heatmap_Generic_Visual : MonoBehaviour
{
    ...
    public void SetGrid(Generic_Grid<HeatMapGridObject> grid)
    {
        this.grid = grid;
        UpdateHeatMapVisual();
    ...
    private void Grid_OnGridVauleChanged(object sender, Generic_Grid<HeatMapGridObject>.OnGridValueChangedEventArgs e)
    {
        updateMesh = true;
    }
