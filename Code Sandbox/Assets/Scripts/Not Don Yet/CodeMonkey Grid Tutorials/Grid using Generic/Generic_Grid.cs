...
public class Generic_Grid<TGridObject> : MonoBehaviour
{
    ...
    public Generic_Grid(int width, int height, float cellSize, Vector3 originPosition, Func<Generic_Grid<TGridObject>, int, int,TGridObject> createGridObject)
    {
        this.width = width;
        this.height = height;
